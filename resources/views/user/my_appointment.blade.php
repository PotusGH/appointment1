...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          ...
          <li class="nav-item">
            <a class="nav-link" style="background-color:greenyellow; color:blue " href="
            {{url('myappointment')}}">My Appointment</a>
          </li>
  ...
  <div align="center" style="padding: 70px;">
    ...
    <table>
        <tr style="background-color: rgb(34, 0, 255);">
            ...
            <tr style="background-color:black;" align="center">
                ...
                <td><a class="btn btn-danger" onclick="
                return confirm('Are you sure you want to delete this?')" href="
